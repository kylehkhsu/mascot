...
public:
    ...
    vector<UniformGrid*> Ts_; /*!< Ts_[i] stores the transition relation of abstraction i. */
    vector<UniformGrid*> TTs_; /*!< TTs_[i] is Ts_[i] with X2s_[i] existentially abtracted. */
    ...
    void onTheFlyReach(int p, sys_type sysNext, rad_type radNext, X_type x, U_type u) {
		...
		UniformGrid Ds_[0](*system_->dimX_, *system_->lbX_, *system_->ubX_, etaXs_[0]);
