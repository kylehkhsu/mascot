// whirlpoolDiscrete with moving auxiliary targets
#include <array>
#include <iostream>
#include <cmath>
...
const int numAbs = 4; // 2-1;
const double tau = 2.4; // 0.3 for the finest layer
...
void composition() {
    ...
    double bEtaX[bDimX]= {2.4, 2.4}; // 0.3 for the finest layer
    ...
    double a0EtaX[a0DimX] = {  4, 8}; // {0.5 8} for the finest layer
    a0X_t a0x;
    double a0EtaRatioX[a0DimX] = {2, 1};

    double a1LbX[a1DimX] = {   0, -3};
    double a1UbX[a1DimX] = {   8,  3};
    double a1EtaX[a1DimX] = {  8,  4}; // {8, 0.5} for the finest layer
    a1X_t a1x;
    double a1EtaRatioX[a1DimX] = {1, 2};

    double a2LbX[a2DimX] = {  -3, -8};
    double a2UbX[a2DimX] = {   3,  0};
    double a2EtaX[a2DimX] = {  4,  8}; // {0.5 8} for the finest layer
    a2X_t a2x;
    ...
    GBuchi abs("whirlpoolDiscreteFix.txt");
