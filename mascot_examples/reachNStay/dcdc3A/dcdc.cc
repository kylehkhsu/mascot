...
/* Obstacles and safe states should be complementary */
...
int main() {
    ...
    AdaptAbsReachNStay abs("dcdc3A.log", verbose);
    abs.initialize(&dcdc, dcdcAddS, dcdcAddO);
